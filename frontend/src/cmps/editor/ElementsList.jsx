...
export const ElementsList = ({ onAddElement, onAddSection }) => {
                ...
                <AccordionItem>
                    ...
                    <AccordionItemPanel>
                        <div className="flex column video">
                            <input type="text" value={form.src} name="src"
                                placeholder="YouTube URL" onChange={(ev) => handleChange(ev)} />
                            <button className="text-center pointer" onClick={() => onSubmit()}>OK</button>
                        </div>
                    </AccordionItemPanel>
                </AccordionItem>
            </Accordion>
