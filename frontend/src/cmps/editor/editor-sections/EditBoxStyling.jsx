...
export const EditBoxStyling = ({ isImg, backgroundColor, backgroundImage,
    borderRadius, height, width, onChangeSpecialInput, onChangeValue }) => {

    const backgroundImgPositionOptions = [
    ...
    const backgroundImgSizeOptions = [
        { value: 'cover', label: 'Cover' },
        { value: 'contain', label: 'Contain' },
        { value: 'initial', label: 'Initial' }
    ]

    const backgroundImgRepeatOptions = [
    ...
    const backgroundImgAttachmentOptions = [
        ...
        <>
            ...
            <div className="accordion-inner-content">
                ...
                {!isImg && <div className="flex align-center editor-pref-warper">
                    ...
                    <input type="file" onChange={(ev) => uploadImg(ev)} />
                </div>}
            </div>
                    ...
                    <div className="accordion-inner-content">
                        ...
                        <div className="flex align-center editor-pref-warper">
                            ...
                            <Select
                                ...
                                options={backgroundImgPositionOptions}
                            />
                        </div>
                        ...
                        <div className="flex align-center editor-pref-warper">
                            ...
                            <Select
                                ...
                                options={backgroundImgSizeOptions}
                            />
                        </div>
                        ...
                        <div className="flex align-center editor-pref-warper">
                            ...
                            <Select
                                ...
                                options={backgroundImgRepeatOptions}
                            />
                        </div>
                        ...
                        <div className="flex align-center editor-pref-warper">
                            ...
                            <Select
                                ...
                                options={backgroundImgAttachmentOptions}
                            />
                        </div>
                    </div>
                </>
